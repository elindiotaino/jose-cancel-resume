...
const lines = [
  ...
  "    \\newcommand{\\resumeSidebarItem}[2]{{\\raggedright\\color{white}\\fontsize{8.5pt}{9.5pt}\\selectfont\\textbf{#1}\\par}\\vspace{0.05em}{\\raggedright\\color{white!84}\\fontsize{7.8pt}{8.8pt}\\selectfont #2\\par}\\vspace{0.26em}}",
